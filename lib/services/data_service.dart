  ...
  static List<Property> getMockProperties() {
    return [
      ...
      Property(
        ...
        price: 4500000,
        location: 'الضواحي',
        imageUrl: 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60',
        bedrooms: 5,
        bathrooms: 4,
        area: 400,
        type: 'فيلا',
      ...
      Property(
        ...
        imageUrl: 'https://images.unsplash.com/photo-1555636222-cae831e670b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60',
        bedrooms: 0,
        bathrooms: 1,
        area: 60,
        type: 'محل تجاري',
